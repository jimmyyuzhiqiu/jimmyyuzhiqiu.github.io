const categoryKeys = ["all", "growth", "ai", "data", "competition"];

const content = {
  zh: {
    documentTitle: "余智秋｜AI 业务增长与海外用户增长",
    description: "余智秋的 AI 业务增长、海外用户增长、Growth Marketing 与 AI 商业化运营简历网页。",
    brand: "余智秋",
    nav: ["经历", "项目", "证书", "奖项", "联系"],
    resumeButton: "中文简历",
    languageButton: "EN",
    heroName: "AI 业务增长，海外用户增长",
    heroLines: ["AI 业务增长，", "海外用户增长"],
    heroTitle: "余智秋｜Growth Marketing / 海外增长 / AI 商业化",
    heroIntro:
      "电子科学与技术本科，曾赴芬兰商学院公费交换；在 SMM 参与海外渠道触达、客户线索清洗、英文商务触达和会展增长复盘，在金虹桥承担 CRM 用户增长分析与活动转化复盘，并能用 AIGC、AI Coding、Python 和 Salesforce 交付增长素材、落地页与经营报表。",
    ...
    signals: [
      ...
      ["10 万+", "海外用户触达", "SMM 多语言渠道营销"],
      ["3,102", "可追溯观众参会", "线索追踪与商务对接"],
      ["500+", "AIGC 内容生成", "营销素材工作流效率提升约 83%"],
    ],
    sections: {
      education: ["教育背景", ""],
      experience: ["实习经历", ""],
    ...
    experiences: [
      {
        ...
        place: "上海",
        theme: "海外用户增长 / 线索漏斗 / 英文商务触达",
        points: [
          "整理潜在客户、线上报名客户和参会客户数据，完成去重、分类、字段补充和优先级梳理，支持线索筛选、分层触达和赞助推进。",
          "参与 TikTok、YouTube、Instagram、Facebook 等多语言渠道营销，累计触达 10 万+ 海外用户，互动率约 25%。",
          "参与 20+ 媒体资源置换并维护 30+ 海外合作 / 赞助伙伴，推动参会人数超额完成 KPI 24%；结合 Python 与 Salesforce 新增 200+ 海外企业联系方式。",
        ],
      },
      {
        index: "02",
    ...
    footerTitle: "余智秋",
    footerSubtitle: "AI 业务增长 / 海外用户增长 / Growth Marketing",
    footerResume: "下载一页中文简历",
    certificateAction: "查看原图",
    modalClose: "关闭证书预览",
  },
  en: {
    documentTitle: "Zhiqiu Yu | AI Business Growth & Overseas User Growth",
    description:
      "Zhiqiu Yu's resume portfolio for AI business growth, overseas user growth, Growth Marketing, and AI commercial operations.",
    brand: "Yu Zhiqiu",
    nav: ["Experience", "Projects", "Certificates", "Awards", "Contact"],
    resumeButton: "English CV",
    languageButton: "中文",
    heroName: "AI business growth, overseas user growth",
    heroLines: ["AI business growth,", "overseas user growth"],
    heroTitle: "Zhiqiu Yu | Growth Marketing / Overseas Growth / AI GTM",
    heroIntro:
      "Electronic Science and Technology undergraduate with a business-school exchange in Finland. Experience spans overseas channel reach, lead cleaning, English outreach and event growth review at SMM, CRM user-growth analytics and campaign conversion review at Jinhongqiao Mall, plus AIGC, AI Coding, Python and Salesforce workflows for growth assets, landing pages and operating reports.",
    ...
    signals: [
      ...
      ["100K+", "Overseas user reach", "SMM multilingual marketing"],
      ["3,102", "Traceable event attendees", "Lead tracking and business matching"],
      ["500+", "AIGC content outputs", "Marketing workflow efficiency up about 83%"],
    ],
    sections: {
      education: ["Education", ""],
    ...
    experiences: [
      {
        ...
        role: "Overseas Growth & Marketing Intern",
        period: "2025.01 - 2025.04",
        place: "Shanghai",
        theme: "Overseas user growth / lead funnel / English outreach",
        points: [
          "Organized prospect, online-registration and attendee data; handled deduplication, categorization, field enrichment and lead prioritization for segmented outreach and sponsorship follow-up.",
          "Supported multilingual marketing across TikTok, YouTube, Instagram and Facebook, reaching 100K+ overseas users with around 25% engagement.",
          "Supported 20+ media partnership exchanges and 30+ overseas partners / sponsors, helping attendance exceed KPI by 24%; used Python and Salesforce to add 200+ overseas company contacts.",
        ],
      },
      {
        index: "02",
        company: "Jinhongqiao Mall",
        role: "CRM User Growth Analytics Intern",
        period: "2025.10 - 2025.11",
        place: "Shanghai",
        theme: "User growth / CRM analytics / campaign conversion review",
        points: [
    ...
    footerSubtitle: "AI Business Growth / Overseas User Growth / Growth Marketing",
    footerResume: "Download One-page English CV",
...
const projects = {
  zh: {
    "commerce-web": {
      categoryKey: "growth",
      period: "2025 - 至今",
      title: "AI 产品 / 业务落地页与 GTM 内容交付",
      subtitle: "juyi.asia / dialflow.cn",
      impact: "把 AI 与跨境业务能力转成可访问、可转发、可用于客户沟通的增长页面。",
      description:
        "独立制作并上线 juyi.asia（跨境 3PL 供应链服务展示）与 dialflow.cn（AI 外呼 / 自动拨号场景展示），用 AI Coding、OpenClaw 完成信息架构、页面生成、文案组织和上线迭代，可迁移到 AI 产品官网、海外获客页和销售支持材料。",
      tags: ["GTM", "Landing Page", "AI Coding", "海外获客"],
      links: [
    ...
    "crm-automation": {
      categoryKey: "data",
      period: "2025",
      title: "CRM 用户增长与活动复盘自动化",
      subtitle: "会员增长分析工具 / 白领券核销数据处理",
      impact: "将会员增长、券核销和活动转化复盘沉淀为每月可复跑的数据流程。",
      description:
        "围绕会员新增、累计、同比、环比等指标构建自动化报表，并读取原始券明细回写格式化模板，自动生成汇总表和指定券种明细。",
      tags: ["CRM", "用户增长", "Python", "活动复盘"],
      links: [],
    },
    "ing-review": {
      categoryKey: "data",
  ...
  en: {
    "commerce-web": {
      categoryKey: "growth",
      period: "2025 - Present",
      title: "AI Product / Business Landing Pages and GTM Content",
      subtitle: "juyi.asia / dialflow.cn",
      impact: "Turned AI and cross-border business capabilities into public, shareable pages for customer communication and growth use cases.",
      description:
        "Independently launched juyi.asia for cross-border 3PL services and dialflow.cn for AI outbound-calling scenarios, using AI Coding and OpenClaw for information architecture, page generation, copywriting and launch iteration. The workflow transfers to AI product websites, overseas acquisition pages and sales enablement materials.",
      tags: ["GTM", "Landing Page", "AI Coding", "Overseas acquisition"],
      links: [
        ["juyi.asia", "https://juyi.asia"],
        ["dialflow.cn", "https://dialflow.cn"],
      ],
    ...
    "crm-automation": {
      categoryKey: "data",
      period: "2025",
      title: "CRM User Growth & Campaign Review Automation",
      subtitle: "Member-growth reports / coupon redemption processing",
      impact: "Built a repeatable workflow for member growth, coupon redemption and campaign conversion review.",
      description:
      ...
      tags: ["CRM", "User growth", "Python", "Campaign review"],
      links: [],
    },
    "ing-review": {
      categoryKey: "data",
    ...
    "aigc-opening": {
      categoryKey: "ai",
      period: "2024",
      title: "AIGC Content Production Workflow",
      subtitle: "Qizhi Xuzhang: automatic opening-video generation",
      impact: "Generated 500+ opening clips and reduced per-piece production time from about 30 minutes to about 5 minutes, transferable to marketing content production.",
      description:
      ...
      tags: ["AIGC", "Marketing content", "Stable Diffusion", "Efficiency"],
      links: [],
    },
    "virtual-scene": {
      categoryKey: "competition",
